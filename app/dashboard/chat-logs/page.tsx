  ...
  const [conversations, setConversations] = useState<Conversation[]>([
    {
      ...
      userQuery: "Do you have any 2-bedroom apartments available next month?",
      aiResponse: "Yes, we currently have three 2-bedroom units available for next month. Two are in our Riverside complex starting at $1,450/month, and one is in our Downtown complex at $1,650/month. Would you like more details about any of these properties?",
    ...
    },
    {
      ...
      chatbotId: "chatbot-1",
      chatbotName: "Rental Inquiry Assistant",
      userQuery: "What documents do I need for the rental application?",
      aiResponse: "For a rental application, you'll need to provide the following: 1) Photo ID, 2) Proof of income (pay stubs or offer letter), 3) Employment verification, 4) References from previous landlords, and 5) Application fee of $35. Would you like me to email you our application checklist?",
    ...
    },
    {
      ...
      userQuery: "My kitchen sink is leaking under the cabinet. Can someone come fix it?",
      aiResponse: "I'm sorry to hear about the leak. I've created a maintenance request (Ticket #M-1023) for your kitchen sink. Based on the urgency, a maintenance technician will be at your property within 24 hours. You'll receive a text message when they're on their way. Is there anything else about the leak that we should know?",
    ...
    },
    {
      ...
      chatbotId: "chatbot-2",
      chatbotName: "Maintenance Request Bot",
      userQuery: "The heating isn't working in my apartment",
      aiResponse: "I understand that heating issues are urgent, especially this time of year. I've created a high-priority maintenance request (Ticket #M-1024) for your heating system. A technician will contact you within 4 hours to address this issue. In the meantime, please let us know if you need a temporary space heater.",
